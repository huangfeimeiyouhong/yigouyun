...
const MOCK_DATA = {
  ...
  roles: [
    ...
    { id: 4, name: '监管用户', code: 'inspector', description: '食品安全监管查看权限，可查看预警/留样/晨午晚检/巡检/食安巡查/台账/菜谱/人员等数据（仅查看，不可维护），并查看视频监控', status: 1, userCount: 1, createTime: '2024-03-15', permissions: ['dashboard','alerts','samples','checks','patrol','safetyInspect','ledger','recipes','personnel','monitor'] }
  ],

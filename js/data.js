...
const MOCK_DATA = {
  ...
  // 角色管理
  roles: [
    { id: 1, name: '平台管理员', code: 'admin', description: '系统全部权限，包括参数设置、用户管理、角色权限分配及业务管理等', status: 1, userCount: 1, createTime: '2024-01-01', permissions: ['dashboard','devices','alerts','alertReview','samples','personnel','checks','access','monitor','roles','userMgmt','sysParams','ledger','patrol','safetyInspect','recipes','users','patrolReview'] },
